      ...
      if ($checkResult && $checkResult->num_rows === 1) {
        ...
        if ($seats_reserved > $available) {
          ...
          if (!$existingReservationStmt) {
            ...
            // The user wants to increment their reserved seats with the newly selected seats
            $addedSeats = $seats_reserved;
            $newTotalSeats = $previousSeats + $addedSeats;
            $newTotalPrice = $newTotalSeats * 12.00;
            ...
            if (!$saveStmt) {
              ...
              if ($existingReservation) {
                $saveStmt->bind_param('idsii', $newTotalSeats, $newTotalPrice, $status, $user_id, $screening_id_post);
              } else {
                $saveStmt->bind_param('iiids', $user_id, $screening_id_post, $newTotalSeats, $newTotalPrice, $status);
              }
              ...
              if ($saveStmt->execute()) {
                ...
                if ($updateStmt) {
                  $updateStmt->bind_param('ii', $addedSeats, $screening_id_post);
  ...
  <section class="banner container">
    <div class="reservation-content">
      ...
      <?php if ($success_message !== ''): ?>
        <div
          style="background-color: #28a745; color: white; padding: 15px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
      ...
      <?php if (!$screening && !$success_message): ?>
        <div
          style="background-color: #ffc107; color: #000; padding: 20px; border-radius: 8px; text-align: center; margin-bottom: 20px;">
          <p>No screening selected. Please select a screening from a movie page.</p>
          <a href="main.php" class="btn"
            style="display: inline-block; margin-top: 10px; padding: 10px 20px; background: #e50914; color: white; text-decoration: none; border-radius: 5px;">Back
            to Movies</a>
        </div>
        ...
        <div class="card-container">
          <div class="card-img">
            <?php if (!empty($screening['image_url'])): ?>
              <img src="<?php echo htmlspecialchars($screening['image_url'], ENT_QUOTES, 'UTF-8'); ?>"
                alt="<?php echo htmlspecialchars($screening['title'], ENT_QUOTES, 'UTF-8'); ?>" loading="lazy"
            ...
            <form method="POST" action="reservation.php">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Date"
                    value="<?php echo htmlspecialchars($screening_date, ENT_QUOTES, 'UTF-8'); ?>" readonly disabled />
                </div>

                <div class="form-group">
                  <i class="bx bx-time-five"></i>
                  <input type="text" placeholder="Time"
                    value="<?php echo htmlspecialchars($screening_time, ENT_QUOTES, 'UTF-8'); ?>" readonly disabled />
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Full Name"
                    value="<?php echo htmlspecialchars($user_name, ENT_QUOTES, 'UTF-8'); ?>" readonly disabled />
                </div>
                <div class="form-group">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="number" name="seats" placeholder="How Many Persons?" min="1"
                    max="<?php echo (int) $screening['available_seats']; ?>" required />
                  <small style="color: #999; display: block; margin-top: 5px; font-size: 0.85rem;">Available:
                    <?php echo (int) $screening['available_seats']; ?>/<?php echo (int) $screening['total_seats']; ?>
                    seats</small>
                </div>
              </div>
            ...
            <div class="reservation-card">
              <div class="reservation-poster">
                <?php if (!empty($reservation['image_url'])): ?>
                  <img src="<?php echo htmlspecialchars($reservation['image_url'], ENT_QUOTES, 'UTF-8'); ?>"
                    alt="<?php echo htmlspecialchars($reservation['title'], ENT_QUOTES, 'UTF-8'); ?>" loading="lazy"
                    onerror="this.src='img/aa.PNG'" />
                <?php else: ?>
                  <img src="img/aa.PNG" alt="No image available" />
                <?php endif; ?>
              ...
              <div class="reservation-details">
                ...
                <div class="reservation-footer">
                  ...
                  <span
                    class="reservation-status <?php echo htmlspecialchars(strtolower($reservation['status']), ENT_QUOTES, 'UTF-8'); ?>">
