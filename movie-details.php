...
<body>
	<header>
		<div class="nav container">
			...
			<ul class="nav-menu" style="display: flex; align-items: center; gap: 2rem; list-style: none;">
				<li><a href="main.php" class="nav-link" style="color: #fff; text-decoration: none;">Home</a></li>
				<li><a href="main.php#movies" class="nav-link" style="color: #fff; text-decoration: none;">Movies</a>
				</li>
				<li><a href="contact.html" class="nav-link" style="color: #fff; text-decoration: none;">Contact</a></li>
			</ul>
		</div>
	</header>
		...
		<?php else: ?>
			<section class="details-shell">
				<div class="details-grid">
					<div class="poster">
						<img src="<?php echo h($movie['image_url'] ?: 'img/aa.PNG'); ?>"
					...
					<div class="movie-meta">
						...
						<div class="meta-row">
							...
							<span
								class="pill"><?php echo (($movie['status'] ?? '') === 'available') ? 'Available' : 'Coming Soon'; ?></span>
						</div>
				...
				<div class="trailer-section">
					...
					<?php if ($embedUrl !== ''): ?>
						<div class="video-frame">
							<iframe src="<?php echo h($embedUrl); ?>" title="<?php echo h($movie['title']); ?> trailer"
